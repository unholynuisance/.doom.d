...
#+begin_src emacs-lisp
(defvar satan/default-transparency '(98 . 98))
...
#+begin_src emacs-lisp
(defvar satan/transparent-mode-transparency '(60 . 60))
...
**** Key org roam nodes
#+begin_src emacs-lisp
(defun satan/get-org-roam-file-by-title (title)
  "Get the ID of an Org Roam node with the given TITLE."
  (cl-loop for node in (org-roam-node-list)
           when (string= title (org-roam-node-title node))
           return (org-roam-node-file node)))

(defvar
  satan/org-roam-inbox-node-id
...
(after! org
  (setq! org-capture-templates
         `(("t" "Task" entry
            (file ,(satan/get-org-roam-file-by-title "Inbox")
            "* TODO %? \n %i\n"
            :empty-lines 1)
           ("l" "Library")
           ("lb" "book" entry
            (file+olp ,(satan/get-org-roam-file-by-title "Library") "Inbox")
             "* UNREAD %? :book:\n %i\n"
             :empty-lines 1)
           ("L" "Leisure")
           ("Ln" "novel" entry
            (file+olp ,(satan/get-org-roam-file-by-title "Leisure") "Inbox")
            "* UNREAD %? :novel:\n %i\n"
            :empty-lines 1)
           ("Lf" "film" entry
            (file+olp ,(satan/get-org-roam-file-by-title "Leisure") "Inbox")
...
(org-latex-mp--register-features
 '(font-main
   :snippet "\\setmainfont{Noto Serif}"
   :order typography-fonts
   :eager t )
 '(font-sans
   :snippet "\\setsansfont{Noto Sans}"
   :order typography-fonts
   :eager t)
 '(font-mono
   :snippet "\\setmonofont[Scale=MatchLowercase]{Noto Sans Mono}"
   :order typography-fonts
   :eager t))
#+end_src
