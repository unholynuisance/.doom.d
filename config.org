...
** Custom file
#+begin_src emacs-lisp
(setopt custom-file (file-name-concat doom-profile-cache-dir "custom.el"))
(load custom-file t)
#+end_src
...
Banner:
#+begin_src emacs-lisp
(setq fancy-splash-image (concat (file-name-as-directory doom-private-dir) "share/images/kurisu.xpm"))
#+end_src
...
(package! gptel
  ...
  (:host github
   :repo "karthink/gptel")
  :pin "3c93bccf9a117535f2573e5a9753d6324474689a")
#+end_src
...
(after! gptel
  ...
  (setopt gptel-backend (gptel-get-backend "Copilot")))
#+end_src
...
(package! gptel-agent
  ...
  :pin "e833bcaf617baf8c8075eac098231c4457386814")
#+end_src
...
(use-package! mcp
  ...
  (setopt mcp-hub-servers
         '(("filesystem" .
            (:command "podman"
             :args ("run" "-i" "--rm"
                    "--mount" "type=bind,src=/home/unholynuisance/Projects/,dst=/projects,ro"
                    "mcp/filesystem"
                    "/projects")))))
  ...
  (map! :map mcp-hub-mode-map
        :n "l" #'mcp-hub-view-log
        :n "s" #'mcp-hub-start-server
        :n "k" #'mcp-hub-close-server
        :n "r" #'mcp-hub-restart-server
        :n "S" #'mcp-hub-start-all-server
        :n "R" #'mcp-hub-restart-all-server
        :n "K" #'mcp-hub-close-all-server
        :n "+" #'mcp-hub-add-root
        :n "-" #'mcp-hub-remove-root
        :n "=" #'mcp-hub-view-roots))
#+end_src
...
#+begin_src emacs-lisp
(after! projectile
  (setopt projectile-find-dir-includes-top-level t)
...
(setopt ispell-personal-dictionary (expand-file-name "dictionary" "~/.local/share/ispell/"))
#+end_src
...
#+begin_src emacs-lisp :tangle packages.el
(package! elcord
  :disable (not (executable-find "discord")))
#+end_src
...
(after! org
  ...
  (setopt org-agenda-weekend-days '(0))
...
#+begin_src emacs-lisp
(after! org-attach
  (setopt org-attach-id-dir "~/Org/.attach/"))
#+end_src
...
(package! org-appear
  ...
  :pin "77d23efec5f5c25fc0798364d2b51a3ce3d8d518")
#+end_src
...
(after! ox-latex
  ...
  (setopt org-latex-engraved-theme 'default))
#+end_src
...
#+begin_src emacs-lisp
(after! org
  (setopt org-re-reveal-theme "night"
...
*** Confluence
#+begin_src emacs-lisp :tangle packages.el
(package! ox-confluence-modern
  :recipe
  (:host github
   :repo "nan0scho1ar/ox-confluence-modern")
  :pin "1a855f95a3243c3fffc2f50fd07c50634c9daee6")
#+end_src
...
#+begin_src emacs-lisp
(after! csharp
  (setopt lsp-csharp-server-path "/usr/bin/omnisharp"))
#+end_src
