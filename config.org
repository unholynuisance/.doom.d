...
**** Export settings
#+begin_src conf :tangle (if (executable-find "systemctl") "~/.config/environment.d/texmf.conf" "no")
...
#+begin_src latex :tangle (or "no" "~/.local/share/texmf/tex/xelatex/satan/dstu-report.cls")
