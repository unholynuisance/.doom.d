...
(defun nuisance/load-env-vars ()
  ...
  (nuisance/load-env-var nuisance/system-type "NUISANCE_EMACS_SYSTEM_TYPE")
  (nuisance/load-env-var nuisance/system "NUISANCE_EMACS_SYSTEM")
  )
